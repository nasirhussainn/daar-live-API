...
router.get(
  "/subscriptions-list",
  subscriptionController.getAllSubscriptionsFull,
);
router.get(
  "/subscriptions/:realtor_id",
  subscriptionController.getRealtorSubscriptions,
);
router.put(
...
router.put(
  "/subscription/update-dates/:realtorId",
  subscriptionController.updateSubscriptionDates,
);
